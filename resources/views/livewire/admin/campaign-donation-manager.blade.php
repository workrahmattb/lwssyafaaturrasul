    ...
    <div class="bg-white rounded-2xl shadow-xl border border-emerald-50 overflow-hidden">
        ...
        <div class="px-4 sm:px-6 py-4 bg-gradient-to-r from-emerald-500 to-teal-600 text-white">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                ...
                <div class="flex overflow-x-auto gap-2 pb-2 sm:pb-0 -mx-4 sm:mx-0 px-4 sm:px-0 scrollbar-hide">
            ...
            <table class="w-full text-sm text-left">
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50 transition">
                        ...
                        <td class="px-6 py-4">
                            <span class="font-medium text-slate-700 line-clamp-1 max-w-xs block">{{ $donation->campaign->title ?? '-' }}</span>
                        </td>
                        <td class="px-6 py-4">
                            <div>
                    ...
                    <tr>
                        <td colspan="9" class="px-6 py-12 text-center text-slate-400">
                            ...
                            Tidak ada donasi kampanye untuk ditampilkan.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
        ...
        <div class="md:hidden divide-y divide-slate-100">
            ...
            <div class="p-4 space-y-3">
                ...
                <div class="flex items-start gap-2">
                    ...
                    <span class="font-medium text-sm text-slate-700 line-clamp-2">{{ $donation->campaign->title ?? '-' }}</span>
                </div>
            ...
            <div class="px-4 py-12 text-center text-slate-400">
                ...
                <p class="text-sm text-slate-500">Tidak ada donasi kampanye untuk ditampilkan.</p>
            </div>
            @endforelse
        </div>
