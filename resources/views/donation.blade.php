...
<body class="font-sans antialiased bg-gradient-to-br from-emerald-50 via-white to-teal-50 scroll-smooth">
                ...
                <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-3xl p-6 text-white shadow-xl">
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-2xl font-bold tracking-tight">{{ formatRupiah($wakafPembangunanTotal) }}</p>
                        </div>
                    </div>
                    <p class="text-emerald-100 text-xs">{{ $wakafPembangunanCount }} wakaf terkumpul</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-3xl p-6 text-white shadow-xl">
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-2xl font-bold tracking-tight">{{ formatRupiah($donasiPendidikanTotal) }}</p>
                        </div>
                    </div>
    ...
    <section class="py-12 px-6 bg-gradient-to-br from-emerald-50 via-white to-teal-50">
        <div class="max-w-6xl mx-auto">
            {{-- Header --}}
            <div class="text-center mb-10">
                <h2 class="text-3xl md:text-4xl font-black text-emerald-800 mb-3">Kampanye Wakaf</h2>
    ...
    <section id="riwayat" class="py-12 px-6 bg-white">
        <div class="max-w-4xl mx-auto">
            <div class="text-center mb-8">
                <h2 class="text-3xl font-black text-emerald-800 mb-2">Riwayat Wakaf</h2>
                <p class="text-slate-600">Wakaf yang telah disalurkan oleh para wakif</p>
            </div>
    ...
    <footer class="bg-slate-900 text-white py-12 px-6 mt-12">
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    <h4 class="font-bold mb-4">Jenis Wakaf</h4>
                    <ul class="space-y-2 text-slate-400 text-sm">
                        ...
                        <li><a href="{{ route('campaigns.index') }}" wire:navigate class="hover:text-emerald-400 transition">Kampanye Wakaf</a></li>
                    </ul>
                </div>
                <div>
    ...
    <script>
        ...
        document.addEventListener('livewire:init', () => {
            Livewire.on('scrollToRiwayat', () => {
                setTimeout(() => {
                    const element = document.getElementById('riwayat');
                    if (element) {
